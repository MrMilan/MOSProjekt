package Tradiator
  model pokojikSKotlem
    ...
    Buildings.Fluid.Actuators.Valves.TwoWayLinear val(m_flow_nominal = 1, dpValve_nominal = 101525) annotation(Placement(visible = true, transformation(origin = {-30, 8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res(dp_nominal = 101525, m_flow_nominal = 1) annotation(Placement(visible = true, transformation(origin = {6, 8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res1(dp_nominal = 101525, m_flow_nominal = 1) annotation(Placement(visible = true, transformation(origin = {74, 8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Buildings.Fluid.Delays.DelayFirstOrder del(m_flow_nominal = 1, nPorts = 3, V = 0.02) annotation(Placement(visible = true, transformation(origin = {36, -72}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    Buildings.Fluid.Storage.ExpansionVessel exp(V_start = 1) annotation(Placement(visible = true, transformation(origin = {36, -36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res2(dp_nominal = 101525, m_flow_nominal = 1) annotation(Placement(visible = true, transformation(origin = {-38, -62}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    Buildings.Fluid.HeatExchangers.HeaterCooler_u hea(Q_flow_nominal = Q_flow_nominal, m_flow_nominal = 1, dp_nominal = 101525) annotation(Placement(visible = true, transformation(origin = {-4, -62}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Constant dp(k = 101525) annotation(Placement(visible = true, transformation(origin = {-76, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Constant T(k = 3) annotation(Placement(visible = true, transformation(origin = {-16, -32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Constant TSet(k = 360) annotation(Placement(visible = true, transformation(origin = {-46, 82}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
  ...
  model pokojSregulaciDleExample
